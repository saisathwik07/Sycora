...
export class TaskService {
  ...
  createDemoTask(task: Partial<{ title: string; description: string; deadline: string; priority: string }>): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/demo`, task);
  }
